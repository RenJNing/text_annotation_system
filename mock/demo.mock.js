const mock = {
  ...
  //           id: 1,
  //           sentence:
  //             "中国成人2型糖尿病HBA1C  c控制目标的专家共识目前,2型糖尿病及其并发症已经成为危害公众健康的主要疾病之一,控制血糖是延缓糖尿病进展及其并发症发生的重要措施之一。虽然HBA1C  。是评价血糖控制水平的公认指标,但应该控制的理想水平即目标值究竟是多少还存在争议。糖尿病控制与并发症试验(DCCT,1993)、熊本(Kumamoto,1995)、英国前瞻性糖尿病研究(UKPDS,1998)等高质量临床研究已经证实,对新诊断的糖尿病患者或病情较轻的患者进行严格的血糖控制会延缓糖尿病微血管病变的发生、发展,其后续研究DCCT-EDIC(2005)、UKPDS一80(2008)还证实早期有效控制血糖对大血管也有保护作用¨引。这些研究终点的HBA1C  。控制在7.5%左右,那么年龄较大、糖尿病病程较长、部分已有心血管疾病(CVD)或伴CVD极高危因素的糖尿病人群进一步降低血糖,",
  //           mark: {},
  //         },
  //         {
  //           id: 2,
